...
const predefined = {
    ...
    ada: { name: 'Cardano', symbol: 'ADA', color: '#fff' },
    dot: { name: 'Polkadot', symbol: 'DOT', color: '#fff' },
    matic: { name: 'Polygon', symbol: 'MATIC', color: '#fff' },
    avax: { name: 'Avalanche', symbol: 'AVAX', color: '#e84142' },
    bnb: { name: 'Binance Coin', symbol: 'BNB', color: '#f3ba2f' },
    ltc: { name: 'Litecoin', symbol: 'LTC', color: '#bfbbbb' },
    doge: { name: 'Dogecoin', symbol: 'DOGE', color: '#c2a633' },
    trx: { name: 'TRON', symbol: 'TRX', color: '#fff' },
    link: { name: 'Chainlink', symbol: 'LINK', color: '#375bd2' }
};
...
class CryptoDonateElement extends HTMLElement {
    ...
    renderTrigger() {
        ...
        trigger.innerHTML = `
            <div class="cryptodonate-trigger-icons">
                <img src="${svgUrl}btc.svg" alt="BTC" class="crypto-icon crypto-icon-1">
                <img src="${svgUrl}eth.svg" alt="ETH" class="crypto-icon crypto-icon-2">
                <img src="${svgUrl}sol.svg" alt="SOL" class="crypto-icon crypto-icon-3">
            </div>
                ...
                <div class="cryptodonate-crypto-select">
                    <div class="cryptodonate-selected-crypto" data-selected="${selectedCrypto}">
                        <div class="cryptodonate-selected-icon" style="background-color: ${selectedData.color}">
                            <img src="${svgUrl}${selectedCrypto}.svg" alt="${selectedData.symbol}" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
    ...
    updateSelectedCrypto(container, crypto) {
        ...
        selectedCrypto.querySelector('.cryptodonate-selected-icon img').src = `${svgUrl}${crypto}.svg`;
    ...
    generateColorFromString(str) {
        ...
        // Convert to a valid hex color (ensuring good contrast)
