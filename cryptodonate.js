...
class CryptoDonateElement extends HTMLElement {
                ...
                return `
                    <div class="cryptodonate-option" data-crypto="${crypto}">
                        <div class="cryptodonate-option-icon" style="background-color: ${data.color}">
                            <img src="https://raw.githubusercontent.com/Cryptofonts/cryptoicons/refs/heads/master/SVG/${crypto}.svg" alt="${data.symbol}" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                ...
                <div class="cryptodonate-crypto-select">
                    <div class="cryptodonate-selected-crypto" data-selected="${selectedCrypto}">
                        <div class="cryptodonate-selected-icon" style="background-color: ${selectedData.color}">
                            <img src="https://raw.githubusercontent.com/Cryptofonts/cryptoicons/refs/heads/master/SVG/${selectedCrypto}.svg" alt="${selectedData.symbol}" onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
    ...
    updateSelectedCrypto(container, crypto) {
        ...
        selectedCrypto.querySelector('.cryptodonate-selected-icon img').src = `https://raw.githubusercontent.com/Cryptofonts/cryptoicons/refs/heads/master/SVG/${crypto}.svg`;
